...
@Slf4j
@Component
@RabbitListener(queues = RabbitMQConstants.FANOUT_QUEUE, concurrency = "1-4",
        messageConverter="jackson2JsonMessageConverter")
public class FanoutConsumer {

    /**
     * 可以有多个 RabbitHandler ， 但是方法参数不同，比如接受 String, byte[] 等
     * @param user
     * @param message
     * @param channel
     */
    @RabbitHandler
    public void fanoutConsumer1(User user,Message message,  Channel channel) {
